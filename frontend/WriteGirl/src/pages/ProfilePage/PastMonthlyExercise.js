...
export default function PastMonthlyExercisePage({navigation}) {
                ...
                <TouchableOpacity onPress={() => {
                  ...
                  style={styles.backArrow}>
                    ...
                    <View style={styles.openDoor}>
                        <Text style = {styles.openText}>Write a poem describing where you live. Include as much detail as you can!</Text>
